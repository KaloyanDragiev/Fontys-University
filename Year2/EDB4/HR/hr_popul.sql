rem
rem 
rem populating HR tables
rem
rem

rem alter session so the date format is right!
ALTER SESSION SET NLS_LANGUAGE=American; 

REM ***************************insert data into the REGIONS table

rem ******  Populating REGIONS table ....
...
rem ******  Populating COUNTIRES table ....
...
rem ******  Populating LOCATIONS table ....
...
rem ******  Populating DEPARTMENTS table ....
...
rem ******  Populating EMPLOYEES table ....
...
rem ******  Populating JOB_HISTORY table ....
